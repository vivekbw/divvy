 ...
 *
 * Lifecycle:
 *  - Call [start] from [com.favalabs.divvy.MainActivity] after the user is confirmed signed in.
 *  - Call [stop]  from [com.favalabs.divvy.ui.profile.ViewModels.ProfileViewModel.signOut].
 */
@Singleton
